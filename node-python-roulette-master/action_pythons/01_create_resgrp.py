...
endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourcegroups/'+resgrp+'?api-version=2018-08-01'

headers = {"Authorization": 'Bearer ' + access_token,"Content-Type":"application/json"}
son = requests.put(endpoint,headers=headers,data=data).json()
# print son
result=son["properties"]

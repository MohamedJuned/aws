...
endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourceGroups/'+resgrp+'/providers/Microsoft.Network/publicIPAddresses/'+ip_name+'?api-version=2018-11-01'

headers = {"Authorization": 'Bearer ' + access_token,"Content-Type":"application/json"}	
son = requests.put(endpoint,headers=headers).json()
entry=son["value"]
print entry[0]["name"]

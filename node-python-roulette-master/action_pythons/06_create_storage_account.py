...
storagename=sys.argv[4]  #textbox
...
data='{"sku": {"name": "Standard_LRS"}, "kind": "storageV2", "location": "%s"}'%(location)

endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourceGroups/'+resgrp+'/providers/Microsoft.Storage/storageAccounts/'+storagename+'?api-version=2018-02-01'

headers = {"Authorization": 'Bearer ' + access_token,"Content-Type":"application/json"}
son = requests.put(endpoint,headers=headers,data=data)
print son

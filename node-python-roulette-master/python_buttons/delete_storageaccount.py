...
storagename=sys.argv[3]       #textbox
...
endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourceGroups/'+resgrp+'/providers/Microsoft.Storage/storageAccounts/'+storagename+'?api-version=2018-07-01'

headers = {"Authorization": 'Bearer ' + access_token,"Content-Type":"application/json"}
son = requests.delete(endpoint,headers=headers)
print son

...
endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourceGroups/'+resgrp+'/providers/Microsoft.Compute/virtualMachines/'+vmname+'/start?api-version=2018-06-01'

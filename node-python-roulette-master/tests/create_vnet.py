...
addr=sys.argv[4]         #textbox
subnet_name=sys.argv[5]  #textbox
vname=sys.argv[6]        #textbox
...
data='{"location": "%s","properties": {"addressSpace": {"addressPrefixes": ["%s"]},"subnets": [{"name": "%s","properties": {"addressPrefix": "%s"}}]}}'%(location,addr,subnet_name,addr)

endpoint = 'https://management.azure.com/subscriptions/'+subscription+'/resourceGroups/'+resgrp+'/providers/Microsoft.Network/virtualNetworks/'+vname+'?api-version=2018-08-01'
